...
`1+x` is valid, `1+` is defined, `add1` is not defined:  MIT, Guile, SCM, XLisp, Rep, Elk, FemtoLisp, Inlab, LIPS, STklos

`1+x` is valid, `1+` is not defined, `add1` is not defined:  Gauche, Gambit, Bigloo, Kawa, JScheme, Shoe, TinyScheme, Scheme 9, BDC, Schemik, Llava, Sagittarius
